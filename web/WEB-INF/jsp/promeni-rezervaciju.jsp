...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <sf:form class="form-horizontal" method="POST" action="promeni-rezervaciju" modelAttribute="promenjenaRezervacija">
                <c:if test="${hasErrors}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <sf:input type="text" class="form-control" id="idIstrazivaca" path="idIstrazivaca"/>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <sf:button type="submit" class="btn btn-default">Promeni rezervaciju</sf:button>
                        <a class="btn btn-primary"href="lista-rezervacija">Vrati se na listu rezervacija</a>
                    </div>
                </div>
        </sf:form>
    </div>
